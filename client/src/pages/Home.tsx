...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans relative">
      ...
      {/* Inventionem Section */}
      <section id="inventionem" className="py-24 px-4 md:px-8 bg-[#1a1a1a] text-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="rounded-[32px] overflow-hidden shadow-2xl h-[500px]">
            <img 
              src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80" 
              alt="Inventionem Gastronomy" 
              className="w-full h-full object-cover"
            />
          </div>
          <div className="space-y-8">
            <h2 className="text-4xl md:text-6xl font-serif font-bold text-accent">
              {t.inventionem.title}
            </h2>
            ...
            <Button 
              className="bg-accent text-black font-bold hover:bg-accent/90 px-8 py-6 rounded-xl uppercase tracking-widest"
      ...
      {/* Frescos y Orgánicos Section */}
      <section id="frescos" className="py-24 px-4 md:px-8 bg-[#fdfdfd]">
        <div className="max-w-7xl mx-auto text-center mb-16 space-y-4">
          <h2 className="text-4xl md:text-6xl font-serif font-bold text-[#232323]">
            {t.frescos.title}
          </h2>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
          {[
            { 
              ...
              icon: <div className="w-16 h-16 bg-[#e8f5e9] rounded-2xl flex items-center justify-center mb-6"><Users className="text-[#2e7d32] w-8 h-8"/></div>
            },
            { 
              title: t.frescos.items[1].title, 
              desc: t.frescos.items[1].desc, 
              icon: <div className="w-16 h-16 bg-[#e8f5e9] rounded-2xl flex items-center justify-center mb-6"><ShieldCheck className="text-[#2e7d32] w-8 h-8"/></div>
            },
            { 
              title: t.frescos.items[2].title, 
              desc: t.frescos.items[2].desc, 
              icon: <div className="w-16 h-16 bg-[#e8f5e9] rounded-2xl flex items-center justify-center mb-6"><Star className="text-[#2e7d32] w-8 h-8"/></div>
            }
          ].map((item, idx) => (
            <div key={idx} className="p-10 bg-white border border-border/40 rounded-[32px] shadow-sm hover:shadow-md transition-shadow">
              {item.icon}
              <h3 className="text-2xl font-serif font-bold text-[#232323] mb-4">{item.title}</h3>
