    ...
    return (
      <div data-testid={`calculator-${cabin.id}`} className="bg-card border border-border/60 rounded-2xl p-5 space-y-4">
        ...
        <Button
          ...
          size="lg"
          className="w-full bg-[#25D366] hover:bg-[#20BD5A] text-black text-sm py-5 rounded-xl shadow-none transition-all hover:scale-[1.02] border-0 uppercase tracking-widest font-bold"
